...
$default = "videos_new.php?id=2017_210";
...
<html>
	<head>
		<link rel="stylesheet" href="CSS/videos_new.css"/>
					...
					<div class="dropdown-content">
						<?php
							foreach($run_options as $key => $value){
								...
								echo "<a href='videos_new.php?id=".$key."'>&nbsp;".$value."</a>";
							}
						?>
					</div>
				</div>
				...
				<div class="logo_section">
					...
					<div class="controls">
						...
						<div class="toggle-facts">
							Show facts? <input type="checkbox" id="showFacts" checked />
						</div>
						<br>
